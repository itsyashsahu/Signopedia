            ...
            <section className="z-20 flex-grow h-96 flex item-center justify-center">
                ...
                <div className='flex h-fit place-self-center w-3/5 justify-between ' >
                    ...
                    <div className="text-center text-gray-500 p-10">
                        <img className="mx-auto mb-4 w-80 h-80 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="Bonnie Avatar" />
                        <h3 className="mb-1 text-2xl font-bold tracking-tight text-white ">
                            <a href="#">Vansh Kumar Sharma</a>
                        </h3>
                        <ul className="flex justify-center mt-4 space-x-4">

                            <li>
                                <a href="mail:vns.vansh123@gmail.com" className="text-white opacity-60 hover:opacity-100">
                            ...
                            <li>
                                <a href="#" className="text-white opacity-60 hover:opacity-100">
                            ...
                            <li>
                                <a href="#" className="text-white opacity-60 hover:opacity-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-github"><path fill='currentColor' d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                                </a>
                            </li>
                        </ul>
                    </div>
